                    ...
                    + '<ul class="nav navbar-nav">'
                        + '<li class="dropdown">'
                            ...
                            + '<ul class="dropdown-menu">'
                                ...
                                + '<li><a class="dropdown-submenu glyphicon glyphicon-import" href="#import"> Import</a></li>'
                                + '<li><a class="export glyphicon glyphicon-export" href="#export"> Export</a></li>'
                                + '<li><a class="connect glyphicon glyphicon-cloud" href="#connect"> Connect</a></li>'
                                + '<li class="disabled user-option"><a class="save glyphicon glyphicon-floppy-disk" href="#save"> Save</a></li>'
                                + '<li class="disabled user-option"><a class="save-as glyphicon glyphicon-floppy-disk" href="#save-as"> Save As...</a></li>'
                                + '<li class="disabled user-option"><a class="load glyphicon glyphicon-folder-open" href="#load"> Load</a></li>'
                            + '</ul>'
                        + '</li>'
                    + '</ul>'
